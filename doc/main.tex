...
% Use a common built-in BibTeX style; change to IEEEtran if installed
...
\begin{titlepage}
    ...
    % ---------- Gambar tengah ----------
    \vspace{1.8cm}
    \includegraphics[width=0.5\textwidth]{../public/images/profile.jpeg}\par
...
\input{sections/04-implementasi-pengujian.tex}
